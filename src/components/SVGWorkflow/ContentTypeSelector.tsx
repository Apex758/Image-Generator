...
export const contentTypes: ContentTypeOption[] = [
  {
    ...
    description: 'Visual reading and comprehension activities',
    icon: <BookOpen className="h-6 w-6" />,
    color: 'bg-blue-50 border-blue-200 text-blue-700',
    examples: ['Picture books analysis', 'Visual storytelling', 'Reading comprehension with images'],
    minImages: 1,
    maxImages: 1,
  },
  {
    id: 'comic',
    name: 'Comic Strip',
    description: 'Sequential storytelling and narrative activities',
    icon: <Smile className="h-6 w-6" />,
    color: 'bg-purple-50 border-purple-200 text-purple-700',
    examples: ['Story sequences', 'Character development', 'Dialogue practice'],
    minImages: 2,
    maxImages: 4,
  },
  {
    id: 'math',
    name: 'Math Worksheet',
    description: 'Mathematical problems and visual exercises',
    icon: <Calculator className="h-6 w-6" />,
    color: 'bg-green-50 border-green-200 text-green-700',
    examples: ['Problem solving', 'Visual math concepts', 'Interactive calculations'],
    minImages: 1,
    maxImages: 1,
  },
  {
    ...
    description: 'Customizable educational worksheets',
    icon: <FileText className="h-6 w-6" />,
    color: 'bg-orange-50 border-orange-200 text-orange-700',
    examples: ['Fill-in-the-blanks', 'Matching exercises', 'Custom activities'],
    minImages: 1,
    maxImages: 4,
  }
];
